...
import type { LngLat, Place } from "@/types/planner";
import { useExtractMapData } from "@/hooks/use-extract-map-data";
import { useUserLocation } from "@/hooks/use-user-location";
import { useVoice } from "@/hooks/use-voice";

const PlannerMap = dynamic(() => import("./map/planner-map"), { ssr: false });
...
export default function Planner() {
  ...
  const resetChat = useCallback(() => {
    ...
    setFocusCoord(null);
  }, [stop, setMessages, setSelectedRouteIdx, setFocusCoord]);
  ...
  const { mapPlaces, activeRoute } = useExtractMapData(messages, selectedRouteIdx);
